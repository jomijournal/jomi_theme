...
<head>
	...
	function place_mixpanel_id_in_cookie()
	{
	...
	if (window.location.hostname.toLowerCase().search(productionHost) < 0) {
    		mixpanel.init(devToken, { loaded: place_mixpanel_id_in_cookie });
	} else {
    		mixpanel.init(prodToken, { loaded: place_mixpanel_id_in_cookie });
	}
</script>
        <!-- end Mixpanel -->
